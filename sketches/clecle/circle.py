...
class Circle():
    ...
    def __init__(self, pos, r, rand, plt):
        self.pos = pos
        self.r = r
        self.rand = rand
        self.theta1 = 0
    ...
    def update(self):
        if self.theta1 > PI:
            ...
            # self.vel1 = -PI * random(0.005, 0.00505)
        elif self.theta1 < 0:
            self.vel1 *= -1
            
        if self.theta2 > PI:
            # self.vel2 *= -1
            # self.vel2 = -PI * random(0.005, 0.00505)
        ...
        if self.theta3 > TAU:
            # self.vel3 *= -1
            # self.vel3 = -PI * random(0.004, 0.00405)
        ...
        if self.theta4 > TAU:
            # self.vel4 *= -1
            # self.vel4 = -PI * random(0.006, 0.00605)
